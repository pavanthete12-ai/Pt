import { Bot, ChartCandlestick, Files, FolderKanban, Globe2, LayoutDashboard, Mic2, Settings, Sparkles } from 'lucide-react';
import type { NavigationItem } from '../types/navigation';
export const primaryNavigation:NavigationItem[]=[
{id:'dashboard',label:'Dashboard',icon:LayoutDashboard,description:'System overview'},
{id:'trading',label:'QuantPulse',icon:ChartCandlestick,description:'Live market terminal'},
